      ...
      <div className="bg-white border border-slate-200 w-full max-w-md rounded-2xl shadow-xl overflow-hidden animate-zoom-in">
        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-4">
          <div className="flex items-center gap-2 bg-mint-50/50 border border-mint-100/60 p-2.5 rounded-xl text-[10px] text-slate-600 font-semibold">
            <Shield className="w-3.5 h-3.5 text-mint-600 flex-shrink-0" />
          ...
          <div>
            <label className="block text-xs font-bold text-slate-600 uppercase mb-1">Nombre Comercial / Compuesto</label>
            <input
              type="text"
              required
          ...
          <div>
            <label className="block text-xs font-bold text-slate-600 uppercase mb-1">Dosis recomendada</label>
            <input
              type="text"
              required
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-xs font-bold text-slate-600 uppercase mb-1">Stock Actual</label>
              <input
                type="number"
                min="0"
                required
            ...
            <div>
              <label className="block text-xs font-bold text-slate-600 uppercase mb-1">Stock Máximo</label>
              <input
                type="number"
                min="1"
                required
          ...
          <div>
            <label className="block text-xs font-bold text-slate-600 uppercase mb-1">Hora de toma diaria</label>
            <input
              type="time"
              required
              value={horaToma}
          ...
          <div>
            <label className="block text-xs font-bold text-slate-600 uppercase mb-1">Notas / Instrucciones (Opcional)</label>
            <textarea
